...
private:
	...
	std::vector<VkDescriptorSet> descriptorSets;	// implicitly freed when pool is destroyed
	...
	void createTextureImage() {
		...
		stbi_uc* pixels = stbi_load("textures/bernstein.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
